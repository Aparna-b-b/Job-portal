            ...
            {viewApplicationsPageData.map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b text-center flex'>
                  <img className='q-10 h-10rounded-full mr-3 max-sm:hidden' src={assets.imgSrc} alt='' />
                ...
                <td className='py-2 px-4 border-b'>
                  ...
                  className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center'>Resume<img src={assets.resume_download_icon} alt='' /></a>
                </td>
